...
def _read_data(path, extend_claim: bool = False):
    ...
    table = pd.read_csv(path, sep='\t', header=0, quoting=csv.QUOTE_NONE, index_col=False)

    def str2num(lab):
        # convert bool label to int
        lab = str(lab) if type(lab) == bool else lab
        # assert lab == "TRUE" or lab == "True" or lab == "False" or lab == "FALSE" or lab == "MIXED" or lab == "false" or lab == "true"
        if lab == "TRUE" or lab == "True" or lab == "true" or lab == "mostly true":
            return 1
        elif lab == "FALSE" or lab == "False" or lab == "false" or lab == "mostly false":
            return 0
        else:
            return 2
